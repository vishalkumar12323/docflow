...
export default function RotatePage() {
    ...
    const handleRotate = async (degrees: number) => {
        ...
        try {
            const newPdfBytes = await rotatePdf(file, degrees, selectedPages.length > 0 ? selectedPages : undefined);
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500">Rotate specific pages or the entire document.</p>
                    </div>
                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t">
                                    <div className="text-sm text-slate-500">
                                        {selectedPages.length === 0 ? "All pages will be rotated" : `${selectedPages.length} pages selected`}
                                    </div>
